...
# This code is copied from `sphinx.ext.napoleon` v5.1.1. Any changes have
# been labelled with `jmontalt`.
...
class GoogleDocstring:
    ...
    docstring : :obj:`str` or :obj:`list` of :obj:`str`
        ...
        individual lines.
    config: :obj:`myst_napoleon.Config` or :obj:`sphinx.config.Config`
        The configuration settings to use. If not given, defaults to the
        config object on `app`; or if `app` is not given defaults to the
        a new :class:`myst_napoleon.Config` object.
    ...
    Example
    -------
    >>> from myst_napoleon import Config
    ...
    def _parse_generic_section(self, section: str, use_admonition: bool) -> List[str]:
        ...
        if use_admonition:
            # jmontalt: use MyST syntax instead of RST.
